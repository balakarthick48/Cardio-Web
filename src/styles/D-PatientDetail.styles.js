export const PatientStyles = {
    ...
    meetingProcessActions: { display: 'flex', alignItems: 'flex-end', gap: 8, marginTop: 16 },
    processButton: { color: '#fff', padding: '10px 18px', borderRadius: 6, border: 'none', width: 120 },
    resetButton: { background: '#fff', border: '1px solid #dfe7ff', padding: '10px 14px', borderRadius: 6, cursor: 'pointer', width: 120 },
    nextMeetup: { fontSize: 24 },
    nextMeetupDate: { fontSize: 24},
