...
const getTodayDate = () => {
    ...
    //         }
    //         let url = `${API_BASE_URL}patient/appointments/date_month?date=${selectedDate}&month=${month}&year=${year}`;
    //         console.log('Fetching:', url);
    //         const response = await fetch(url, {
    //             method: 'GET',
    //             headers: { 'Content-Type': 'application/json' }
...
console.log('appointment>>><<<', appointment);
    ...
    // Call getAppointment when selectedMonth changes and filterType is 'monthly'
    useEffect(() => {
